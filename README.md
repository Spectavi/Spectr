# 📈 spectr — Open-Source Algo-Trading Terminal
...
| `V`      | Push-to-talk voice assistant   |
...
````
The voice agent uses your system default input/output devices; there is no in-app audio settings dialog.
